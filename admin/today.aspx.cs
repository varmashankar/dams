...
public partial class admin_today : System.Web.UI.Page
{
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(doctorID))
                {
                    ...
                    LoadTodayAppointments(departmentId); // Pass the department ID to load appointments
                }
            }
        }
    }

    private void LoadTodayAppointments(string departmentId)
    {
        string query = @"
    ...
    ORDER BY A.AppointmentTime ASC";
        ...
        using (SqlConnection conn = new SqlConnection(strcon))
        {
            ...
            {
                // Pass the DepartmentID as a parameter
